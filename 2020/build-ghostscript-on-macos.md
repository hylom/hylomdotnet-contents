...
・libpng（[・littleCMS（lcms、[http://www.littlecms.com/download.html](http://www.littlecms.com/download.html)(http://www.libpng.org/pub/png/libpng.html]）)）
・jbig2dec（[・libjpeg（[http://www.ijg.org](http://www.ijg.org)(https://jbig2dec.com]）)）
